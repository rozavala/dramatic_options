...
from dramatic_options import breach_audit, clusters, fixed_basket, shadow_book, state
from dramatic_options.council.scoring import agent_contribution
from dramatic_options.council_health_report import council_l1_health
...
def curation_panel(conn, config: dict, market=None) -> dict:
    ...
    from dramatic_options import basket_quality, cluster_diagnostic
